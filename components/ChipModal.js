...
const s = {
  ...
  destItemBlock: { marginBottom: 'var(--space-2)' },
  destRow: {
    display: 'flex',
    alignItems: 'center',
    gap: 'var(--space-3)',
  ...
  dmFlexBody: { marginBottom: 'var(--space-2)' },
  dmFlexCounterBlock: {
  ...
  paxCatLabel: { fontFamily: 'var(--font-sans)', fontWeight: 'var(--fw-bold)', fontSize: 'var(--text-md)', color: 'var(--ta-ink)' },
  paxCatSub: { fontFamily: 'var(--font-sans)', fontSize: 'var(--text-sm)', color: '#7f7466', marginTop: 'var(--space-px)' },
  paxStepper: { display: 'flex', alignItems: 'center', gap: 'var(--space-3)', flexShrink: 0 },
  paxRoundBtn: {
    width: 'var(--space-7)',
    height: 'var(--space-7)',
    borderRadius: '50%',
  ...
  paxHintIcon: { fontSize: 'var(--text-md)', lineHeight: 1.4, flexShrink: 0 },
  paxHintTextWrap: {
    display: 'flex',
    flexDirection: 'column',
    gap: 'var(--space-2)',
  ...
  counterRow: { display: 'flex', alignItems: 'center', gap: 'var(--space-3)' },
  counterBtn: {
    width: 36, height: 36,
    borderRadius: '50%',
    borderWidth: 'var(--border-thick)',
  ...
  counterVal: { fontFamily: 'var(--font-sans)', fontWeight: 'var(--fw-bold)', fontSize: 'var(--text-lg)', minWidth: 24, textAlign: 'center', color: 'var(--text1)' },
