...
export function getTripWorkspace(tripId) {
  ...
  return {
    ...
    plan: {
      ...
      bookedServices: Array.isArray(raw.plan?.bookedServices)
        ? raw.plan.bookedServices
        : def.plan.bookedServices,
      paidServices: Array.isArray(raw.plan?.paidServices)
        ? raw.plan.paidServices
        : def.plan.paidServices,
...
export function saveTripWorkspace(tripId, partial) {
  ...
  if (partial.plan && typeof partial.plan === 'object') {
    ...
    if (partial.plan.bookedServices !== undefined) {
      next.plan.bookedServices = partial.plan.bookedServices;
    }
    if (partial.plan.paidServices !== undefined) {
      next.plan.paidServices = partial.plan.paidServices;
    }
